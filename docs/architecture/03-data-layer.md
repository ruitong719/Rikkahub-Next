...
| **RepositoryModule** | ConversationRepo、FolderRepo、MemoryRepo、GenMediaRepo、FilesRepo、FavoriteRepo、WorkspaceManager(filesDir/workspaces + ProotShellRunner(nativeLibraryDir) + 固定 bindMounts /skills,/tool_outputs,/upload)、RootfsInstaller、WorkspaceRepository、FilesManager、SubAgentRunMonitor、ShellRunMonitor、WorkspaceMountManager、WorkspaceBgManager、SkillManager |
